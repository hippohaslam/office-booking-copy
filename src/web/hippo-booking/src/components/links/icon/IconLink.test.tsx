...
test("Icon button should show correctly", async () => {
    ...
    render(
        <BrowserRouter>
            <IconLink title="Add" to="/" iconSrc={AddIcon} color="navy" showBorder showText/>
        </BrowserRouter>
    );
...
test("Text is not shown if argument set to false", async () => {
    ...
    render(
        <BrowserRouter>
            <IconLink title="Add" iconSrc={AddIcon}to="/" color="navy" showBorder={false} showText={false}/>
        </BrowserRouter>
    );
    ...
    expect(link).toHaveAttribute("aria-label", "Add");
});
...
test("Border should be in classname if showBorder is set to true", async () => {
    ...
    render(
        <BrowserRouter>
            <IconLink title="Add" to="/" iconSrc={AddIcon} color="navy" showBorder showText={false}/>
        </BrowserRouter>
    );
...
test("Border should not be in classname if showBorder is set to false", async () => {
    ...
    render(
        <BrowserRouter>
            <IconLink title="Add" to="/" iconSrc={AddIcon} color="navy" showBorder={false} showText={false}/>
        </BrowserRouter>
    );
