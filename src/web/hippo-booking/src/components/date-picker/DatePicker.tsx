        ...
        <div>
            ...
            <div className="date-picker-container">
                ...
                <DatePicker 
                    ...
                    icon={<svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#000000">
                    ...
                    className="date-control date-input" calendarIconClassName="date-input-icon"/>
                <button type="button" className="date-control date-button next" aria-label="next date" title="Next date" onClick={() => adjustDate('next')}/>
            </div>
        </div>
    )
}
