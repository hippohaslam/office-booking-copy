...
import { BookingCancelTime } from "../../../constants/BookingConstants";
...
const BookingDetails = () => {
  ...
  if (!data) {
    ...
    const formattedDateTime = new Date(data?.date!).toLocaleDateString("en-GB", {
      weekday: "long",
      day: "numeric",
      month: "long",
      year: "numeric",
      ...
      <div>
        ...
        {new Date(data.date).setHours(0, 0, 0, 0) >= new Date().setHours(0, 0, 0, 0) ? (
          <>
            ...
            <p>
              On the morning of your booking you will receive a message on Slack asking you to confirm whether you would like to keep this
              booking.
            </p>
            <p>
              If you have not confirmed the booking by {BookingCancelTime.friendlyTime} then it will be automatically cancelled. We do this so that spaces can be booked
              by other Hippos if you're no longer able to make your booking.
            </p>
          </>
        ) : (
