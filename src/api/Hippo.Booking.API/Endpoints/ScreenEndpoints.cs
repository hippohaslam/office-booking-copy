...
public class ScreenEndpoints() : EndpointBase("screen", "Screen", AccessLevelEnum.Anonymous)
{
    ...
    {
        builder.MapGet("availablity/{bookableObjectId}",
            async Task<Results<Ok<BookableObjectBookingStateResponse>, BadRequest<string>>> (IBookingQueries bookingQueries, int bookableObjectId) =>
            {
