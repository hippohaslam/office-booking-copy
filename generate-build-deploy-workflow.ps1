...
try {
    ...
    [void]$PromptBuilder.AppendLine("Adhere strictly to GitHub Actions YAML syntax rules, expressions, and built-in functions (e.g., for string manipulation, context access). Ensure all properties, actions, and expressions conform precisely to the official GitHub Actions documentation.")
